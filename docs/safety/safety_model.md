...
1. **Scope safety** — Is the feature within personal-first WellBe scope?
2. **Data safety** — Is each claim source-linked and labeled by type/quality?
...
5. **Privacy safety** — Is sharing user-scoped, revocable, and minimal?
